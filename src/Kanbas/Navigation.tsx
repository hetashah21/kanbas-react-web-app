...
export default function KanbasNavigation() {
  return (
    <div id="wd-kanbas-navigation" style={{ width: 120 }}  
      ...
      className="list-group-item bg-black border-0 text-center">Northeastern</a>
      ...
      <Link to="/Kanbas/Labs" id="wd-labs-link" className="list-group-item text-white bg-black text-center border-0">
